...
#mu      = 0.62 
#muH     = 1/0.75
#X_solar, Y_solar, Z_solar = 0.71, 0.27, 0.02 # solar metallicity
...
def fractionMetallicity(fracZ):
    ...
    muHp       = mup/Xp
    #Xp, Yp, Zp, mup, muHp = 0.71, 0.27, 0.02, 0.62, 1/0.75
...
def Onephase_Cloud_Evo(t, state):
    ...
    Mdot_loss    = Mdot_coefficient * 3.0 * M_cloud * v_turb_cold /  r_cloud #correction for chi**0.5 factor
